...
本文件用于把 `role-based-agent-governance` 整理成一个适合公开分发，并可被 SkillsMP 收录的 skill 仓库。
...
```bash
git remote add origin https://github.com/awfaups/role-based-agent-governance.git
...
4. SkillsMP 下一轮同步后是否能搜索到 `role-based-agent-governance`
